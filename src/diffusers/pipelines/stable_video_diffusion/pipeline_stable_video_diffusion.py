...
class StableVideoDiffusionPipeline(DiffusionPipeline):
    ...
    def _encode_vae_image_modified(
        self,
        image: torch.Tensor,
        vae: None,
        device: Union[str, torch.device],
        ...
        image_latents = rearrange(image_latents, "(b f) c h w -> b f c h w", f=frame_length)
    ...
    def _decode_vae_image_modified(
        self,
        latents: None,
        vae: None,
        num_frames: None,
